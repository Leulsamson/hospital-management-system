...
const navItems = [
  ...
  { label: "Medical Records", href: "/dashboard/medical-records", roles: ["ADMIN", "DOCTOR", "NURSE", "PATIENT"] },
  { label: "Prescriptions", href: "/dashboard/prescriptions", roles: ["ADMIN", "DOCTOR", "NURSE", "PATIENT"] },
  { label: "Medications", href: "/dashboard/medications", roles: ["ADMIN", "DOCTOR", "NURSE", "RECEPTIONIST"] },
  { label: "Payments", href: "/dashboard/payments", roles: ["ADMIN", "RECEPTIONIST", "PATIENT"] },
  { label: "Inventory", href: "/dashboard/inventory", roles: ["ADMIN", "NURSE"] },
  { label: "Users", href: "/dashboard/users", roles: ["ADMIN"] },
  { label: "Audit Logs", href: "/dashboard/audit-logs", roles: ["ADMIN"] },
  { label: "Analytics", href: "/dashboard/analytics", roles: ["ADMIN", "DOCTOR", "NURSE", "RECEPTIONIST"] },
